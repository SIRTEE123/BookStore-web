...
const FormProduct = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("จะลบจริงๆ หรอ")) {
      try {
        console.log("กำลังลบสินค้า ID:", id); // เพิ่มบรรทัดนี้เพื่อตรวจสอบ ID
        const res = await deleteProduct(token, id);
        console.log("ผลลัพธ์การลบสินค้า:", res); // ตรวจสอบผลลัพธ์จาก API
        toast.success("Deleted สินค้าเรียบร้อยแล้ว");
        getProduct(); // อัปเดตรายการสินค้าใหม่
      } catch (err) {
        console.log("เกิดข้อผิดพลาดขณะลบสินค้า:", err);
